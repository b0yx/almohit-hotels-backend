...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'cloud' => [
            'driver' => 's3',
            'key' => env('CLOUD_ACCESS_KEY_ID', env('AWS_ACCESS_KEY_ID')),
            'secret' => env('CLOUD_SECRET_ACCESS_KEY', env('AWS_SECRET_ACCESS_KEY')),
            'region' => env('CLOUD_DEFAULT_REGION', env('AWS_DEFAULT_REGION', 'auto')),
